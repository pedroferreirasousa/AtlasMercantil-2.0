      ...
      <WrapperDepoiments>
        ...
        <DepoimentsContainer draggable="true">
          <Depoiment>
            ...
            <DepoimentText>
              A AtlasMercantil transformou a produtividade da nossa fazenda.
              Graças às soluções inovadoras, conseguimos aumentar nossa colheita
              de maneira eficiente e sustentável. A equipe técnica nos apoiou em
              cada etapa, tornando nossa operação mais rentável e consciente
              ambientalmente.{" "}
            </DepoimentText>
            <DepoimentPeople>
              João Pereira, Proprietário da Fazenda Boa Vista
            </DepoimentPeople>
          </Depoiment>
          ...
          <Depoiment>
            ...
            <DepoimentPeople>
              Maria Souza, Gerente de Produção na AgroSul
            </DepoimentPeople>
          </Depoiment>
          ...
          <Depoiment>
            ...
            <DepoimentText>
              {" "}
              A parceria com a estabelecida com a Atlas foi fundamental para
              alcançar nossos objetivos. Além de melhorarmos nossos resultados
              financeiros, agora podemos praticar uma agricultura mais
              sustentável, o que é essencial para o futuro da nossa fazenda.{" "}
            </DepoimentText>
            <DepoimentPeople>
              Carlos Mendes, Diretor da AgriTech Solutions
            </DepoimentPeople>
          </Depoiment>
        </DepoimentsContainer>
      </WrapperDepoiments>
